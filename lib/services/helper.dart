...
import 'package:uber_eats_driver_app/model/TaxModel.dart';
...
updateWallateAmount(OrderModel orderModel) {
  ...
  FireStoreUtils.orderTransaction(
      orderModel: orderModel, amount: double.parse(finalAmount), driveramount: double.parse(driverAmount.toStringAsFixed(2)));
