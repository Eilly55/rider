...
import 'package:uber_eats_driver_app/ui/container/ContainerScreen.dart';
import 'package:uber_eats_driver_app/ui/onBoarding/OnBoardingScreen.dart';
    ...
    return MaterialApp(
        ...
        darkTheme: ThemeData(
            appBarTheme: AppBarTheme(
                ...
                iconTheme: IconThemeData(color: Color(COLOR_PRIMARY)),
                textTheme:
                    TextTheme(headline6: TextStyle(color: Colors.grey[200], fontSize: 17.0, letterSpacing: 0, fontWeight: FontWeight.w700)),
